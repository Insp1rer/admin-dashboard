...
import { GoDot, GoDotFill, GoPrimitiveDot } from "react-icons/go";
...
const Ecommerce = () => {
  ...
  const gradientStyle = {
    backgroundImage: `linear-gradient(to right, #f9f2fc, ${currentColor})`,
  };
  return (
    <div className="mt-12">
        ...
        >
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl text-gray-600">63,980 ₴</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
